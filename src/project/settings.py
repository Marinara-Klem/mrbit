"""
Django settings for mrbit project.
...
HOST_BASE = env('HOST_BASE', default='127.0.0.1')
HOST_POSTGRES = env('HOST_POSTGRES', default=HOST_BASE)

DATABASES = {
    'default': env.db('DB_DEFAULT', default=f'postgres://mrbit:mrbit@{HOST_POSTGRES}:5432/mrbit')
}
